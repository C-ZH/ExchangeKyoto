...
public class Guestbook {
	public void addPost(String table_name, String name, String content, String time) {
		...
		try {
			...
			try {
				ResultSet row_count = stmt_row_count.executeQuery("SELECT * FROM post");
				...
				String sql = "INSERT INTO post VALUES(" + "'" + id + "', '" + table_name + "', '" + name + "', " + "'"
						+ content + "', " + "'" + time + "')";
	...
	public void addFeedback(String page, int post_id, String name, String content, String time) {
		...
		try {
			...
			try {
				ResultSet row_count = stmt_row_count.executeQuery("SELECT * FROM re_post");
				...
				System.out.println(id);
				String sql = "INSERT INTO re_post" + " VALUES(" +  id + ", " + "'" + name + "', " + "'"
	...
	public String[] showPost(String content){
		//String space_word[] = content.split(" "); // onlt a space!
