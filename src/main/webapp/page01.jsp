...
<% 
	...
	try {
		...
		try {
			// 建立SQL查詢
			/* post name for table */
			article_title = "page01";
			String sql = "SELECT * FROM post WHERE page = '" + article_title + "'";
...
<title>Test Page01 | 留言板Demo</title>
						...
						<!-- Post -->
							<article class="post">
								...
								<div id="all_gb">
									...
									<% 
										sql = "SELECT * FROM re_post WHERE page = '" + article_title + "' AND post_id = " + rs.getInt("post_id");
